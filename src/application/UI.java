...
public class UI {
    ...
    public static ChessPosition readChessPosition(Scanner sc) {
        try {
            ...
            throw new InputMismatchException("Erro a ler ChessPosition: Valores válidos são de a1 a h8.");
        }
    }
    ...
    public static void printMatch(ChessMatch chessMatch, List<ChessPiece> captured) {
        ...
        if (!chessMatch.getCheckmate()) {
            System.out.print("A vez do jogador: ");
            if (chessMatch.getCurrentPlayer() == Color.WHITE) {
                System.out.println(ANSI_WHITE + "BRANCO" + ANSI_RESET);
            } else {
                System.out.println(ANSI_YELLOW + "AMARELO" + ANSI_RESET);
            }
            if (chessMatch.getCheck()) {
                System.out.println("\n" + ANSI_RED_BACKGROUND + " XEQUE! " + ANSI_RESET);
            }
        } else {
            System.out.println("\n" + ANSI_RED_BACKGROUND + " XEQUE-MATE! " + ANSI_RESET);
