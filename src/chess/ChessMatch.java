...
public class ChessMatch {
    ...
    public List<ChessPiece> getCapturedPieces() {
        return capturedPieces.stream().map(x -> (ChessPiece)x).collect(Collectors.toList());
    }
    ...
    private void undoMove(Position source, Position target, Piece capturedPiece) {
        ...
        // DESFAZER JOGADA ESPECIAL: PEQUENO ROQUE
        if (p instanceof King && target.getColumn() == source.getColumn() + 2) {
        ...
        // DESFAZER JOGADA ESPECIAL: GRANDE ROQUE
        if (p instanceof King && target.getColumn() == source.getColumn() - 2) {
            Position sourceT = new Position(source.getRow(), source.getColumn() - 1);
